<template>
	...
	>
		<view
		    class="u-radio__image-wrap"
		    @tap.stop="iconClickHandler"
		    :class="iconClasses"
			v-if="activeImg&&img" 
		>
			<image class="u-radio__image-wrap_img" :style="{width:$u.addUnit(elIconSize*2),height:$u.addUnit(elIconSize*2)}" :src="checked?activeImg:img"></image>
		</view>
		<view
			v-else
