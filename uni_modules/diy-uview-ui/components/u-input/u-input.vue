<template>
	...
	>
		<textarea
			...
			class="u-input__input u-input__textarea" :class="{disabled:(disabled || type === 'select')}" 
			:style="[getStyle]"
			:value="defaultValue"
		...
		<input
			v-else
			class="u-input__input" :class="{disabled:(disabled || type === 'select')}" 
...
export default {
	...
	data() {
		return {
			...
			textareaHeight: 200, // textarea的高度
