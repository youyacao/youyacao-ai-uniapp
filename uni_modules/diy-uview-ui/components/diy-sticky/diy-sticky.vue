<template>
	<view class="">
		<view class="diy-sticky-wrap" :class="[elClass,className]" :style="{
			height: fixed ? height + 'px' : 'auto',
			backgroundColor: bgColor
		}">
			<view class="diy-sticky" :style="{
...
<script>
	 ...
	 * @example <diy-sticky offset-top="200"><view>塞下秋来风景异，衡阳雁去无留意</view></diy-sticky>
	 */
	export default {
		name: "diy-sticky",
		props: {
