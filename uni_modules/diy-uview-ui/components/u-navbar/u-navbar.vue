<template>
	<view class="">
		<view class="u-navbar" :style="[navbarStyle]"
			:class="[isFixed?'u-navbar-fixed':'',borderBottom?'u-border-bottom':'',bgColor]">
			<view class="u-status-bar" :style="{ height: statusBarHeight + 'px' }"></view>
			<view class="u-navbar-inner" :style="[navbarInnerStyle]">
				<view v-if="isBack||isHome" class="flex align-center" :class="isCapsule?'diy-navbar-solid':'diy-navbar-default'">
					...
					<view class="diy-navbar-split" :style="{
								borderLeft: '1px solid '+ backIconColor
							}" v-if="isHome&&isBack"></view>
					<view class="u-back-wrap u-back-home" v-if="isHome" @tap="getHome">
						<view class="u-icon-wrap">
							<u-icon name="home" customPrefix="diy-icon" :color="backIconColor"
								:size="backIconSize"></u-icon>
						</view>
					</view>
				</view>
				<view class="u-navbar-content-title" v-if="!isSlot&&(title||isSlotTitle)" :style="[titleStyle]">
					<view class="u-title u-line-1" v-if="isSlotTitle" :style="{
											color: titleColor,
					...
					<view class="u-title u-line-1" v-else :style="{
											color: titleColor,
											fontSize: titleSize + 'rpx',
											fontWeight: titleBold ? 'bold' : 'normal'
										}">
