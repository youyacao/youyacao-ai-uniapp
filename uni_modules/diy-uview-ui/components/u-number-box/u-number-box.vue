...
<template>
	<view class="u-numberbox">
		<view
			...
			:class="{'u-icon-radius': isBtnRadius,'u-icon-hide':isHideMin&&inputVal <=  min, 'u-icon-disabled': disabled || inputVal <= min }"
			:style="{
				width:inputHeight + 'rpx',
				background: bgColor,
		...
		<input
			...
			:style="{
				...
				fontSize: size + 'rpx',
				background: inpubBgColor||bgColor,
				height: inputHeight + 'rpx',
		...
		<view
			...
			@touchend.stop.prevent="clearTimer"
			:class="{ 'u-icon-hide':isHideMax&&inputVal >= max, 'u-icon-radius': isBtnRadius,'u-icon-disabled': disabled || inputVal >= max }"
			:style="{
				width:inputHeight + 'rpx',
				background: bgColor,
				height: inputHeight + 'rpx',
