      ...
      <view class="lucky-imgs">
        <view v-for="(block, index) in blocks" :key="index">
          <view v-if="block.imgs">
            <view v-for="(img, i) in block.imgs" :key="i">
...
<script>
  import { changeUnits, resolveImage, getImage } from '../diy-lucky-wheel/utils.js'
  import { LuckyGrid } from '../diy-lucky-wheel/lucky-canvas'
  export default {
    name: 'lucky-grid',
    data () {
      return {
