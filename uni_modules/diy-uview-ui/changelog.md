...
* 如 `diy-icon-goods`，则组件的 `customPrefix` 属性自动识别为 `diy-icon` ，`name`属性 自动识别为 `goods`
* 如 `diy-2-icon-goods-list`，则组件的 `customPrefix` 属性自动识别为 `diy-2-icon` ，`name`属性 自动识别为 `goods-list`
## 1.3.7（2022-06-10）
